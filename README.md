...
![Technologies](https://skillicons.dev/icons?i=py,django,fastapi,nginx,postgresql,mysql,mongodb,redis,linux,git,docker,html,css,sass,bootstrap,js,react,redux&perline=9)
